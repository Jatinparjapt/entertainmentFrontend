...
import { userSingupDetailsReducer } from "../../Redux/loginReducer";
...
const Signup = () => {
  ...
  // save details of new User to send data 
...
// login user using google 
  const signupWithGoogle = async (event) => {
    ...
    try {
      ...
      const { displayName, email, emailVerified, photoURL, accessToken } =
        result.user;
      dispatch(
        setLoggedUserData({
          displayName,
      ...
      // stsTokenManger , accessToken , expirationTime ,displayName , email ,emailVerified , photoUrl
    } catch (error) {
      console.log(error);
    }
  };
          ...
          <div className="container p-4  mt-20 rounded-lg my-8 ">
            ...
            <div className="bg-[#161D2F] rounded-xl ">
              <div className="flex m-6 justify-center">
                <h1 className="text-3xl text-zinc-200 ">Singup</h1>
              </div>
              ...
              {isVaildEmail ?  "": <p className="flex justify-center  text-red-500 mt-1">
                    Email is required !
                  </p>
                }
              ...
              {isValid ?  "": <p className="flex justify-center items-center text-red-500 mt-1">
